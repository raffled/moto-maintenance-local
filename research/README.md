...
| 6 | [retrieval_validation.ipynb](retrieval_validation.ipynb) | Validates `agent/retrieval.py` — demonstrates semantic search, BFS dependency walk (fork disassembly chain surfacing 6.10/6.11 as prerequisites of 6.12), image path deduplication across result sets, torque spec passthrough, and ordering verification across four representative queries. |
